...
export default function Blog2(props) {
	...
	const handleonClick = async (e) => {
		const res = await axios.post("https://blogwebsite-vqdo.onrender.com/deleteblog", {
			id: e.target.id
		});
			...
			<div className="container col-4 mx-3 my-3" style={{ width: "18rem" }}>
				<div className="card">
					...
					<div className="card__body bg-dark d-flex">
						...
						<button type="button" id={props.obid} onClick={handleonClick} className='btn btn-danger'><MdDelete> </MdDelete> Take Down</button>
					</div>
